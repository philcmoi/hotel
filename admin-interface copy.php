...
<body>
    <div class="admin-container">
        ...
        <div class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li>
                    <a href="graphique-reservations.php"><i class="fas fa-chart-bar"></i> Statistiques</a>
                </li>
                <li>
                ...
                <form id="export-form">
                    <div class="form-group">
                        ...
                        <select id="export-type" class="form-select" required>
                            ...
                            <option value="paiements">Paiements</option> <!-- Nouvelle option -->
                        </select>
                    </div>
    ...
    <script>
        ...
        if (this.value === 'reservations' || this.value === 'paiements') {
